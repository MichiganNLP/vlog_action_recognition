...
def filter_transcripts(PATH_captions, path_root, PARAM_LEAST_NB_WORDS_PER_SEC):
    PATH_problematic_transcripts = path_root + "videos_captions" + "/problematic_captions/"
    PATH_problematic_videos = path_root + "videos_captions" + "/problematic_videos/"
    ...
    with open(path_root + 'new_data.json', 'w+') as outfile:
